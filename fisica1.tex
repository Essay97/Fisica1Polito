...
\newcommand{\deriv}[2][t]{\frac{d{#2}}{d{#1}}}
\newcommand{\derivtwo}[2][t]{\frac{d^2{#2}}{d{#1}^2}}
...
\begin{document}
	...
	\item Legge oraria: \( x(t) = x_0 + v_0\cdot(t-t_0) + \frac{1}{2}a\cdot (t-t_0)^2 
		\xlongrightarrow{ t_0 = 0 \,} x(t) = x_0 + v_0t+ \frac{1}{2}at^2\)
	...
	\item Accelerazione: \( \vec{a} = \ddot{s}(t)\vec{\tau}(t) + \frac{\dot{s}^2(t)}{\rho(t)}\vec{n}(t) \)
	\end{itemize}
	...
	\begin{itemize}
	\item \( \tan\phi = \frac{x_0\omega}{v_0} \)
	\item \( A^2 = x_0^2+\frac{v_0^2}{\omega_0} \)
	\end{itemize}
	\end{tcolorbox}
	\begin{itemize}
	\item Posizione: \( x(t) = A\sin(\omega t + \phi) \)
	\item Periodo: T = \( \frac{2\pi}{\omega} \) \hspace{5mm} Pulsazione: \( \omega = \frac{2\pi}{T} \) 
	\item Frequenza: \( f = \frac{1}{T} = \frac{\omega}{2\pi} \)
	...
	\item Accelerazione: 
		...
		& = -\omega^2x(t) 
		\end{align*}
	\item Condizione necessaria e sufficiente per il moto armonico: \( \frac{d^2x}{dt^2}+\omega^2x = 0 \)
	\end{itemize}

	\subsection{Moto Circolare Uniforme}
	\begin{itemize}
	\item Accelerazione centripeta: \( \vec{a}_N = \frac{v^2}{R}\vec{u}_N \qquad \vec{a}_N = \omega^2R\vec{u}_N \)  
	\item Velocità angolare: \( \omega = \frac{v}{R} \rightarrow v = \omega R \)
	\item Periodo: \( T = \frac{2\pi R}{v} \rightarrow v = \omega R \)
	\item Velocità in forma vettoriale: \( \vec{v} = \vec{\omega} \times \vec{r} \)
	\end{itemize}

	\subsection{Moto Circolare Uniformemente Accelerato}
	\begin{itemize}
	\item Legge oraria: \( \theta(t) = \theta_0 + \omega_0 t + \frac{1}{2}\alpha t^2 \)
	...
	\item Legge oraria delle componenti:
		...
		\end{align*}
	\item Traiettoria: \( y(x) = y_0 + \tan\theta\cdot(x-x_0) - \frac{g}{2v_0^2\cos^2\theta}(x-x_0)^2 \)
	\item Massima altezza (supponendo \( (x_0=0)\) e \( (y_0=0) \): 
		\[
		t_{max} = \frac{v_0\sin\theta}{g} \qquad 
		x_{max} = \frac{v_0^2\sin2\theta}{2g} \qquad
		y_{max} = \frac{v_0^2\sin^2\theta_0}{2g} 
		\]
	\item Gittata:  \( x_G = \frac{v_0^2\sin2\theta}{g} \rightarrow \text{doppio del punto di massima altezza}\)
	\end{itemize}
	...
	\begin{itemize}
	\item Forza gravitazionale: \( \abs{\vec{F}_G} = \gamma \frac{m_1 m_2}{r^2} \quad \text{con} \, \gamma = \scinot{6.673}{-11} \, \si{\newton\metre\squared\per\kilo\gram\squared} \)
	\item Forza elettrostatica: \( \abs{\vec{F}_E} = \frac{1}{4\pi\epsilon_0} \frac{q_1 q_2}{r^2} \quad \text{con} \, \frac{1}{4\pi\epsilon_0} = \scinot{8.99}{9} \, \si{\newton\metre\squared\per\coulomb\squared}\)
	...
	\item Attrito dinamico: \( \vec{F}_d = -\mu_d N \frac{\vec{v}}{\abs{\vec{v}}} \)
